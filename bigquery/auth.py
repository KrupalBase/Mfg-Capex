...
<html>
<head>
    <title>Mfg Budgeting - Sign In</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        p { color: #8892b0; margin-bottom: 32px; font-size: 14px; }
        .error { color: #ff6b6b; margin-bottom: 16px; font-size: 13px; }
        .btn-google {
            display: inline-flex;
            align-items: center;
            gap: 12px;
...
<body>
    <div class="login-card">
        <h1>Mfg Budgeting</h1>
        <p>Sign in with your Base Power account to continue.</p>
