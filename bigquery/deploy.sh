...
# Public-safe deployment: secrets must be injected via environment variables.
...
ENV_COMMON="GCS_BUCKET=$BUCKET,GOOGLE_CLIENT_ID=$GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET=$GOOGLE_CLIENT_SECRET,FLASK_SECRET_KEY=$FLASK_SECRET_KEY"
